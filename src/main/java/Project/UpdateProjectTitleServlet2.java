...
@WebServlet("/title")
public class UpdateProjectTitleServlet2 extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
               ...
               if(hs!=null)
               {
         	   ...
         	   pb.setProjectId(req.getParameter("pid")); pb.setProjectTitle(req.getParameter("title"));
         	   
         		int k = new ProjectDAO().updateTitle(pb);
         		if(k>0) {
